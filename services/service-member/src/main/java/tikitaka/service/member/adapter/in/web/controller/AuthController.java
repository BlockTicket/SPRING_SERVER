...
import tikitaka.service.member.adapter.in.web.data.request.auth.LoginCorporationRequest;
import tikitaka.service.member.adapter.in.web.data.request.auth.LoginMemberRequest;
import tikitaka.service.member.adapter.in.web.data.response.AuthResponse;
