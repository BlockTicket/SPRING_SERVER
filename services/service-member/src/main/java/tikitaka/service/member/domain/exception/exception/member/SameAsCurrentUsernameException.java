...
public class SameAsCurrentUsernameException extends CommonException {

	public SameAsCurrentUsernameException() {super(MemberStatusCode.SAME_AS_CURRENT_USERNAME); }
}
